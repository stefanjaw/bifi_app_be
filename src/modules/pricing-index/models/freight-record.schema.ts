  ...
  items: {
    ...
    properties: {
      rate_type: {
        ...
        description:
          "Rate type, mode, or shipping type (e.g. sea, air, ground)",
      },
      carrier: {
        anyOf: [{ type: Type.STRING }, { type: Type.NULL }],
      ...
      hs_code: {
        anyOf: [{ type: Type.STRING }, { type: Type.NULL }],
        description:
          "Harmonized System (HS) tariff code or customs classification code",
      },
      duty_rate_pct: {
        anyOf: [{ type: Type.NUMBER }, { type: Type.NULL }],
        description:
          "Customs duty or tariff rate expressed as a percentage (e.g. 22.5 means 22.5%)",
      },
      product_description: {
        anyOf: [{ type: Type.STRING }, { type: Type.NULL }],
        description:
          "Product or commodity description from the tariff schedule",
      },
      source_file: {
        anyOf: [{ type: Type.STRING }, { type: Type.NULL }],
        description:
