...
/** Mongoose document interface for an intervention record */
export interface InterventionDocument extends mongoose.Document {
  admissionGoalId: mongoose.Types.ObjectId;
  state: string;
  patientId: mongoose.Types.ObjectId;
  archived: boolean;
  contentTitle: string;
  contentBody: string;
  outcomes: mongoose.Types.ObjectId[];
  orderSetIds: mongoose.Types.ObjectId[];
